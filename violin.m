...
%     end
    ...
    if bxplt==1
        if size(rgbLine, 1)==1 
            boxplot(y, g, 'notch','on', 'Color',[0.4 0.4 0.4], 'Symbol','o', 'Widths',0.3, 'OutlierSize',3, 'Jitter',0.75, 'Whisker',2)
        else
            boxplot(y, g, 'notch','on', 'Color',[0.4 0.4 0.4], 'ColorGroup',g, 'Symbol','o', 'Widths',0.3, 'OutlierSize',3, 'Jitter',0.75, 'Whisker',2)
        end
    end
